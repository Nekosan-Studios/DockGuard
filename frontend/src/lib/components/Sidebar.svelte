<script>
  ...
  const navItems = [
    ...
    },
    {
      href: '/running',
      label: 'Running',
      icon: `<svg viewBox="0 0 16 16" fill="currentColor"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M6.271 5.055a.5.5 0 0 1 .52.038l3.5 2.5a.5.5 0 0 1 0 .814l-3.5 2.5A.5.5 0 0 1 6 10.5v-5a.5.5 0 0 1 .271-.445z"/></svg>`
    },
    {
      href: '/images',
      label: 'Images',
...
<aside class="sidebar">
  <div class="sidebar-header">
    ...
    <span>DockerSecurityWatch</span>
  </div>

  <nav class="sidebar-nav">
    {#each navItems as item}
      {#if item.disabled}
        <span class="nav-item" style="opacity: 0.4; cursor: default;" title="Coming soon">
          {@html item.icon}
          {item.label}
          <span style="font-size: 10px; margin-left: auto; color: var(--muted);">soon</span>
        </span>
      {:else}
        <a
          href={item.href}
