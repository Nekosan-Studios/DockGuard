...
<div class="flex flex-col gap-6">
		...
		<Card.Root class="transition-colors hover:bg-muted/50">
			<a href="/vulnerabilities?report=kev" class="block h-full">
				...
				<Card.Content>
					...
					{:else}
						<div
							class="text-2xl font-bold {data.summary.kev_count >
							0
		...
		<Card.Root class="transition-colors hover:bg-muted/50">
			<a href="/vulnerabilities?report=new" class="block h-full">
				...
				<Card.Content>
					...
					{:else}
						<div
							class="text-2xl font-bold {(data.summary
								.new_vulns_24h ?? 0) > 0
	...
	<Card.Root>
		<Card.Header>
			...
			<Card.Description>
				Total critical vulnerabilities across all scanned images per
				day.
			</Card.Description>
		</Card.Header>
		<Card.Content>
