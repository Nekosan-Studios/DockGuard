	...
	<Card.Root>
		<Card.Header class="flex flex-row items-center justify-between">
			<div class="space-y-1.5">
				...
				<Card.Description
					>Images currently running, cross-referenced with the latest
					scan results.</Card.Description
				>
			</div>
			{#if anyContainerHasVex}
				...
				>
					...
					<Tooltip.Root>
						...
						<Tooltip.Content>
							Hide vulnerabilities where the supplier has declared
							them "not affected" or "fixed" via VEX attestations.
						</Tooltip.Content>
					</Tooltip.Root>
				</label>
			{/if}
