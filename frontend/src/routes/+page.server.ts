...
export const load: PageServerLoad = async ({ fetch }) => {
	...
	const summary =
		summaryOk
			...
			: { running_containers: null, images_scanned: null, critical_count: null, kev_count: null, new_vulns_24h: 0, trend: [], docker_connected: false, grype_version: null, db_schema: null, db_built: null, last_db_checked_at: null };
